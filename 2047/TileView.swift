...
class TileView: UIView {
    ...
    init(frame: CGRect, appearanceSource: TileAppearance) {
        _label = UILabel(frame: CGRect(x: 0, y: 0, width: frame.width, height: frame.height))
    ...
    func configureWith(_ appearanceSource: TileAppearance) {
        ...
        let locations: Array<AnyObject> = [CGFloat(0.0) as AnyObject, CGFloat(1.0) as AnyObject]
        ...
        _gradientLayer.locations = (locations as! [NSNumber])
    }
}
